...
| | |
| ----------- | ----------- |
| <a href="https://github.com/briaugenreich/aws-certification-resources.git"><img alt="The Journey To AWS Pro" align="center" width="400" src="docs/images/aws_study_group.png"></a> | **The Journey To AWS Pro - a cloud cert study group** <br/><br/> This study group will have 4 phases with a series of sessions preparing participants to reach the AWS Pro Certification. <br><br> Members will walk through guided exam material overviews, hands on labs , practices tests and lots of discussion points. This journey will not only help prepare you to pass the exam, but we will also build on our community experience to apply our learnings to real world projects. <br><br> Phase One: The Solution Architect Associate will be 7 sessions geared towards achieving the AWS SA Associate Certification. <br/><br/>  -Bri Augenreich, _Master Software Engineer|Leadership Fellow_ |
